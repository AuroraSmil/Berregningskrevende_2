...
\begin{figure}
    \centering
    \begin{subfigure}
        \includegraphics[width = 0.49\textwidth]{Images/block_sim_t.pdf}
        \caption{Caption}
        \label{fig:my_label}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width = 0.49\textwidth]{Images/block_sim_t_sigma10.pdf}
        \caption{Caption}
        \label{fig:my_label}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width = 0.49\textwidth]{Images/block_sim_beta.pdf}
        \caption{Caption}
        \label{fig:my_label}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width = 0.49\textwidth]{Images/block_sim_beta_sigma10.pdf}
        \caption{Caption}
        \label{fig:my_label}
    \end{subfigure}
    \caption{}
