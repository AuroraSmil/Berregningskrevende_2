...
results to estimate the marginal posterior distributions f(t1|x), f(⁄0|x), f(⁄1|x) and f(—|x).
Use also the simulated values to estimate E[t1|x], E[⁄0|x], E[⁄1|x] and Cov[⁄0,⁄1|x]. Dette må plottes, eller er det noe vi har plottet? }
