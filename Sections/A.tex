...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \label{fig:block_burnin_beta}
    \end{subfigure}
    \caption{Trace plots for $n = 10000$ simulations of the different parameters with the block MCMC algorithm. The initial values used are the same as for single site MCMC, namely $\lambda_0 = 10, \lambda_1 = 5$. For t and $\beta$ we use (1901, 3), (1861, 10) and (1931, 0.1) }
    \label{fig:burnin_blockMH}
\end{figure}
